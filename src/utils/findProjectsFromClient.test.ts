...
const id1 = "2ebfad09bacb0c0cc031b5fa";
...
const id2 = "e729699c1e86e4a760a51f5b";
...
const testProjects2 = [
  ...
  {
    id: "a6854a347b16abfa4b455aa4",
    clientId: "e729699c1e86e4a760a51f5b5",
    employeeIds: [
      "8d2d0bddb91ba4cef080e7ac",
      "eeceadced5b5cb1c0cf247d1",
      "5bb9d3f7bcd57f86eaea9599",
...
test("returns all projects which contain clientId", () => {
  expect(findProjectsFromEmployee(id1, testProjects1)).toEqual([
    {
      id: "f0b83d3a0b77da97ec7eefc4",
      clientId: "2ebfad09bacb0c0cc031b5fa",
      employeeIds: [
  ...
  expect(findProjectsFromEmployee(id2, testProjects2)).toEqual([
    {
      id: "f0b83d3a0b77da97ec7eefc4",
      clientId: "e729699c1e86e4a760a51f5b",
      employeeIds: [
  ...
  expect(findProjectsFromEmployee(id3, testProjects3)).toEqual([]);
  expect(findProjectsFromEmployee(id4, testProjects4)).toEqual([]);
});
